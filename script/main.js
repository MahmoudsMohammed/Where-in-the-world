...
function displayCountries(res) {
  ...
  res.forEach(function (e) {
    content += "\n      <a class=\"box\" id=\"".concat(e.name.common, "\">\n      <img src=\"").concat(e.flags.png, "\" alt=\"\" id=\"").concat(e.name.common, "\"/>\n      <div class=\"content\" id=\"").concat(e.name.common, "\">\n        <h4 id=\"").concat(e.name.common, "\">").concat(e.name.common, "</h4>\n        <p id=\"").concat(e.name.common, "\"><span id=\"").concat(e.name.common, "\">Population: </span>").concat(e.population, "</p>\n        <p id=\"").concat(e.name.common, "\"><span id=\"").concat(e.name.common, "\">Region: </span>").concat(e.region, "</p>\n        <p id=\"").concat(e.name.common, "\"><span id=\"").concat(e.name.common, "\">Capital: </span>").concat(e.capital, "</p>\n      </div>\n    </a>\n      ");
  });
...
input.addEventListener('keyup', function (e) {
  if (e.target.value === '') {
    ...
    data.forEach(function (e) {
      if (e.name.common.toLocaleLowerCase().includes(_input.toLocaleLowerCase())) {
        countries.push(e);
      }
    });
...
function displayCountry(name) {
  ...
  if (singleCountry.borders !== undefined) {
    singleCountry.borders.forEach(function (e) {
      borders += "<span id=\"border\" style=\"cursor:pointer\">".concat(e, "</span>");
    });
  }
  // loop over languages object
  var languages = '';
  for (var x in singleCountry.languages) {
    languages += "\n            <span>".concat(x, "</span>\n            ");
  }
  // loop over currencies object
  var currencies = '';
  for (var _x in singleCountry.currencies) {
    currencies += "\n          <span>".concat(_x, "</span>\n          ");
  }
  // create html and inject data from API
  var content = "\n          <div class=\"container\">\n          <button id=\"back\">\n            <i class=\"fa-solid fa-arrow-left me-2\" id=\"back\"></i> <span id=\"back\">Back</span>\n          </button>\n          <div class=\"country-container my-5\">\n            <div class=\"image\">\n              <img src=\"".concat(singleCountry.flags.png, "\" alt=\"\" />\n            </div>\n            <div class=\"content\">\n              <p>").concat(singleCountry.name.common, "</p>\n              <div class=\"info\">\n                <div class=\"boxe\">\n                  <p>Native Name: <span>").concat(singleCountry.name.common, "</span></p>\n                  <p>Population: <span>").concat(singleCountry.population, "</span></p>\n                  <p>Region: <span>").concat(singleCountry.region, "</span></p>\n                  <p>Sub Region: <span>").concat(singleCountry.subregion, "</span></p>\n                  <p>Capital: <span>").concat(singleCountry.capital, "</span></p>\n                </div>\n                <div class=\"boxe\">\n                  <p>Top Level Domain: <span>").concat(singleCountry.tld, "</span></p>\n                  <p>Currencies: ").concat(currencies, "</p>\n                  <p>Languages: ").concat(languages, "</p>\n                </div>\n              </div>\n              <div class=\"bord-countries mt-5\">\n                <p>Border Countries:</p>\n                <div>").concat(borders, "</div>\n              </div>\n            </div>\n          </div>\n        </div>\n          ");
...
country.addEventListener('click', function (e) {
  if (e.target.id !== '' && e.target.id === 'back') {
